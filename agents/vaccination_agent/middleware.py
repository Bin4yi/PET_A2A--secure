...
class AsgardeoJWTMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        Args:
            ...
            required_scope: Scope required to access this agent
        ...
        self.agent_id = agent_id or os.getenv('VACCINATION_APP_ID', '')
...
def create_jwt_middleware_from_env(app, required_scope: str, agent_id: str = None):
    ...
    - VACCINATION_APP_ID: This agent's application ID
    
    Args:
        app: The Starlette application
        required_scope: The scope required to access this agent
    ...
    agent_id = agent_id or os.getenv('VACCINATION_APP_ID', '')
